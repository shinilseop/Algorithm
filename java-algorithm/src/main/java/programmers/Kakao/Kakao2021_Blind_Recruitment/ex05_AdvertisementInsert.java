...
public class ex05_AdvertisementInsert {
...
class Solution {
    ...
    public String solution(String play_time, String adv_time, String[] logs) {
        times = new int[toSecond(play_time) + 2];
        ...
        long tmp = answer;
        for (int i = advTime + 1; i < times.length - 1; i++) {
            times[i] += times[i - 1];

            tmp += times[i];
            tmp -= times[i - advTime - 1];
            if (tmp > answer) {
                answer = tmp;
                startIdx = i - advTime;
            }
...
//            int[] idx = new int[times.length];
//            for (int i = 0; i < idx.length; i++) {
//                idx[i] = i;
//            }
//            for (int i = 0; i < idx.length; i++) {
//                System.out.print(String.format("%6d", idx[i]));
//            }
//            System.out.println();
//            for (int i = 0; i < times.length; i++) {
//                System.out.print(String.format("%6d", times[i]));
//            }
//            System.out.println();
