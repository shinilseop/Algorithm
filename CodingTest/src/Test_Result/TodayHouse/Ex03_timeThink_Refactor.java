...
public class Ex03_timeThink_Refactor {
    ...
    public String solution(String tstring, String[][] variables) {
        ...
        while (iter.hasNext()) {
            ...
            while (true) {
                keys.add(key);
                if (!isVariable(value)) break;
                if(!map.containsKey(value.substring(1, value.length() - 1))) break;
                if(value.substring(1, value.length() - 1).equals(oriKey)) break;
    ...
    public static void main(String[] args) {
        Ex03_timeThink_Refactor main = new Ex03_timeThink_Refactor();
